...
public class AuthController{   // 24 hrs project understand complete sign up and login
    ...
    @PostMapping("/signin")
    public ResponseEntity<AuthResponse> signin(@RequestBody LoginRequest loginRequest) throws SellerException, UserException {
