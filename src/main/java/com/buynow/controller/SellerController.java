...
import com.buynow.service.impl.CustomeUserServiceImplementation;
...
//        Seller savedSeller = sellerService.createSeller(seller);
        ...
        //  gets the surrounding(website) and for that surrounding make him a trusted user or person
    ...
    private Authentication authenticate(String username) {
        ...
        //This constructor should only be used by AuthenticationManager or AuthenticationProvider implementations that
        //are satisfied with producing a trusted (i.e. isAuthenticated() = true)authentication token.
    }
