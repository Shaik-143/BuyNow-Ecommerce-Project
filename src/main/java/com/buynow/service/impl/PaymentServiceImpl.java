...
import com.buynow.domain.PaymentOrderStatus;
import com.buynow.domain.PaymentStatus;
...
import com.buynow.repository.PaymentOrderRepository;
...
//                    System.out.println("payment ===== captured");
    ...
    public PaymentLink createRazorpayPaymentLink(User user, Long Amount, Long orderId) throws RazorpayException {
        ...
        Long amount = Amount * 100; // rozarpay understand in paisa 1 rs = 100 paisa

        try {
            // Instantiate a Razorpay client with your key ID and secret
            RazorpayClient razorpay = new RazorpayClient(apiKey, apiSecret);

            JSONObject paymentLinkRequest = new JSONObject(); // map like thing
...
//            String paymentLinkId = payment.get("id");
    ...
    public String createStripePaymentLink(User user, Long amount,Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .addLineItem(SessionCreateParams.LineItem.builder() // Line Item (The Box) or shirt or total products
                        .setQuantity(1L)  // You are telling Stripe the user is buying exactly 1 unit of this item or total
                        .setPriceData(SessionCreateParams.LineItem.PriceData.builder() // Price Data (The Tag inside the box)
                                .setCurrency("usd")
                                .setUnitAmount(amount*100)
                                .setProductData(SessionCreateParams  // Product Data (The Label on the tag)
                                        .LineItem
                                        .PriceData
                                        .ProductData
                                        .builder()
